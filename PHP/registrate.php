	...
	<div class="contenedor">
		...
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
			...
			<label for="">Correo</label>
				<input type="text" name="correo" id="correo" placeholder="correo" value="<?php echo isset($_POST['correo']) ? $_POST['correo'] : ''; ?>" required>
			</div>

			<div class="entrada">
			<label for="">Usuario</label>
				<input type="text" name="usuario" id="usuario" placeholder="Usuario" value="<?php echo isset($_POST['usuario']) ? $_POST['usuario'] : ''; ?>" required>
			</div>

			<div class="entrada contrasena">
			<label for="">Contraseña</label>
				<input type="password" name="password" id="password" placeholder="Contraseña" value="<?php echo isset($_POST['password']) ? $_POST['password'] : ''; ?>" required>
			...
			<label for="">Confirmar contraseña</label>
				<input type="password" name="password2" id="password_btn" placeholder="Confirmar Contraseña" value="<?php echo isset($_POST['password2']) ? $_POST['password2'] : ''; ?>" required>
