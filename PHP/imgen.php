...
// Realiza una consulta a la base de datos para obtener las URL de las imágenes
$sql = "SELECT Enlace FROM tabla_imgs";
$result = $conexion->query($sql);

// Verifica si la consulta devolvió resultados
if ($result->num_rows > 0) {
  // Crea un arreglo con las URL de las imágenes
  $imagenes = array();
